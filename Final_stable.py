...
def main():
    ...
    root = tk.Tk()
    root.title('WT4.0')
    root.iconbitmap("stable_files\WT4.1.ico")
    ...
    def warn_srt():
        messagebox.showinfo("Before you start", "The tool simply saves typing for me,"
                                                " nothing fancy. \n\nOnce you click a button within a client,"
                                                "\n\nthe text will be copied so Just paste it somewhere 😄")
    ...
    Introstrtbtn_img = Image.open("stable_files/startbt.png")
    Introstrtbtn_photo = ImageTk.PhotoImage(Introstrtbtn_img)

    IntrostrtHbtn_img = Image.open("stable_files/starth.png")
    IntrostrtHbtn_photo = ImageTk.PhotoImage(IntrostrtHbtn_img)

    Introextbtn_img = Image.open("stable_files/ext.png")
    Introextbtn_photo = ImageTk.PhotoImage(Introextbtn_img)

    IntroextHbtn_img = Image.open("stable_files/exth.png")
    IntroextHbtn_photo = ImageTk.PhotoImage(IntroextHbtn_img)

    # BaCK btn img


    back_img = Image.open("stable_files/back1.png")
    backphoto = ImageTk.PhotoImage(back_img)

    back2_img = Image.open("stable_files/back2.png")
    back2photo = ImageTk.PhotoImage(back2_img)

    next_img = Image.open("stable_files/next1.png")
    nextphoto = ImageTk.PhotoImage(next_img)

    next2_img = Image.open("stable_files/next2.png")
    next2photo = ImageTk.PhotoImage(next2_img)

    Br_img = Image.open("stable_files/BRAUN.png")
    Brphoto = ImageTk.PhotoImage(Br_img)

    Br2_img = Image.open("stable_files/BRAUN (1).png")
    Br2photo = ImageTk.PhotoImage(Br2_img)

    cp_img = Image.open("stable_files/cpi.png")
    cpphoto = ImageTk.PhotoImage(cp_img)

    cp2_img = Image.open("stable_files/cpi1.png")
    cp2photo = ImageTk.PhotoImage(cp2_img)

    clbr_img = Image.open("stable_files/Clbr.png")
    clbrphoto = ImageTk.PhotoImage(clbr_img)

    clbr2_img = Image.open("stable_files/Clbr1.png")
    clbr2photo = ImageTk.PhotoImage(clbr2_img)

    jax_img = Image.open("stable_files/jax.png")
    jaxphoto = ImageTk.PhotoImage(jax_img)
    jax2_img = Image.open("stable_files/jax2.png")
    jax2photo = ImageTk.PhotoImage(jax2_img)

    qst_img = Image.open("stable_files/qst.png")
    qstphoto = ImageTk.PhotoImage(qst_img)
    qst2_img = Image.open("stable_files/qst2.png")
    qst2photo = ImageTk.PhotoImage(qst2_img)

    sbr_img = Image.open("stable_files/sbr.png")
    sbrphoto = ImageTk.PhotoImage(sbr_img)
    sbr2_img = Image.open("stable_files/sbr2.png")
    sbr2photo = ImageTk.PhotoImage(sbr2_img)

    usp_img = Image.open("stable_files/usp.png")
    uspphoto = ImageTk.PhotoImage(usp_img)
    usp2_img = Image.open("stable_files/usp2.png")
    usp2photo = ImageTk.PhotoImage(usp2_img)

    bell_img = Image.open("stable_files/bell.png")
    bellphoto = ImageTk.PhotoImage(bell_img)
    bell2_img = Image.open("stable_files/bell2.png")
    bell2photo = ImageTk.PhotoImage(bell2_img)

    vera_img = Image.open("stable_files/vera.png")
    veraphoto = ImageTk.PhotoImage(vera_img)
    vera2_img = Image.open("stable_files/vera2.png")
    vera2photo = ImageTk.PhotoImage(vera2_img)

    afk_img = Image.open("stable_files/afk.png")
    afkphoto = ImageTk.PhotoImage(afk_img)
    afk2_img = Image.open("stable_files/afk2.png")
    afk2photo = ImageTk.PhotoImage(afk2_img)

    misc_img = Image.open("stable_files/misc.png")
    miscphoto = ImageTk.PhotoImage(misc_img)
    misc2_img = Image.open("stable_files/misc2.png")
    misc2photo = ImageTk.PhotoImage(misc2_img)

    FIPbtn_img = Image.open("stable_files/FI2.png")
    FIPbtn_photo = ImageTk.PhotoImage(FIPbtn_img)
    FIPHbtn_img = Image.open("stable_files/FIH.png")
    ...
    Brbtn.place(relx=0.15, rely=0.17, anchor=CENTER, width=100, height=30)
    ...
    cpbtn.place(relx=0.38, rely=0.17, anchor=CENTER, width=100, height=30)
    ...
    clbrbtn.place(relx=0.615, rely=0.17, anchor=CENTER, width=100, height=30)
    ...
    jxbtn.place(relx=0.15, rely=0.83, anchor=CENTER, width=100, height=30)
    ...
    qstbtn.place(relx=0.38, rely=0.835, anchor=CENTER, width=100, height=30)
    ...
    sbrbtn.place(relx=0.613, rely=0.829, anchor=CENTER, width=100, height=30)
    ...
    uspbtn.place(relx=0.84, rely=0.83, anchor=CENTER, width=100, height=30)
    ...
    bellbtn.place(relx=0.38, rely=0.17, anchor=CENTER, width=100, height=30)
    ...
    verabtn.place(relx=0.615, rely=0.17, anchor=CENTER, width=100, height=30)

    Startbtn = tk.Button(intro_pg, border=0, borderwidth=0, relief="sunken", image=Introstrtbtn_photo, cursor="hand2", compound="left", command=lambda: [show_frame(gif_mainpg), warn_srt()])
    Startbtn.place(relx=0.5, rely=0.83, anchor=CENTER, width=100, height=30)
    ...
    Exitbtn.place(relx=0.5, rely=0.90, anchor=CENTER, width=100, height=30)
    ...
    backbtn1.place(relx=0.14, rely=0.5, anchor=CENTER, width=45, height=36)
    ...
    nxtbtn.place(relx=0.84, rely=0.5, anchor=CENTER, width=45, height=36)
    ...
    backbtnfi.place(relx=0.03, rely=0.05, anchor=CENTER, width=45, height=36)
    ...
    backbtn2.place(relx=0.14, rely=0.5, anchor=CENTER, width=45, height=36)
    ...
    backbtncp.place(relx=0.03, rely=0.05, anchor=CENTER, width=45, height=36)
    ...
    backbtnbr.place(relx=0.03, rely=0.05, anchor=CENTER, width=45, height=36)
    ...
    backbtnclbr.place(relx=0.03, rely=0.05, anchor=CENTER, width=45, height=36)
    ...
    backbtnjx.place(relx=0.03, rely=0.05, anchor=CENTER, width=45, height=36)
    ...
    backbtnqst.place(relx=0.03, rely=0.05, anchor=CENTER, width=45, height=36)
    ...
    backbtnsbr.place(relx=0.03, rely=0.05, anchor=CENTER, width=45, height=36)
    ...
    backbtnus.place(relx=0.03, rely=0.05, anchor=CENTER, width=45, height=36)
    ...
    backbtnbl.place(relx=0.03, rely=0.05, anchor=CENTER, width=45, height=36)
    ...
    backbtnvr.place(relx=0.03, rely=0.05, anchor=CENTER, width=45, height=36)
    ...
    grbr1_img = Image.open("stable_files/gr1.png")
    grbr1photo = ImageTk.PhotoImage(grbr1_img)

    grbr2_img = Image.open("stable_files/gr2.png")
    grbr2photo = ImageTk.PhotoImage(grbr2_img)

    clbr1_img = Image.open("stable_files/cl1.png")
    clbr1photo = ImageTk.PhotoImage(clbr1_img)

    clsbr2_img = Image.open("stable_files/cl2.png")
    clsbr2photo = ImageTk.PhotoImage(clsbr2_img)

    cbbr1_img = Image.open("stable_files/cb1.png")
    cbbr1photo = ImageTk.PhotoImage(cbbr1_img)

    cbbr2_img = Image.open("stable_files/cb2.png")
    cbbr2photo = ImageTk.PhotoImage(cbbr2_img)

    tsbr1_img = Image.open("stable_files/ts1.png")
    tsbr1photo = ImageTk.PhotoImage(tsbr1_img)

    tsbr2_img = Image.open("stable_files/ts2.png")
    tsbr2photo = ImageTk.PhotoImage(tsbr2_img)

    snbr1_img = Image.open("stable_files/sn1.png")
    snbr1photo = ImageTk.PhotoImage(snbr1_img)

    snbr2_img = Image.open("stable_files/sn2.png")
    snbr2photo = ImageTk.PhotoImage(snbr2_img)

    apbr1_img = Image.open("stable_files/ap1.png")
    apbr1photo = ImageTk.PhotoImage(apbr1_img)

    apbr2_img = Image.open("stable_files/ap2.png")
    apbr2photo = ImageTk.PhotoImage(apbr2_img)

    mirbr1_img = Image.open("stable_files/mir1.png")
    mirbr1photo = ImageTk.PhotoImage(mirbr1_img)

    mirbr2_img = Image.open("stable_files/mir2.png")
    mirbr2photo = ImageTk.PhotoImage(mirbr2_img)

    inbr1_img = Image.open("stable_files/gi1.png")
    inbr1photo = ImageTk.PhotoImage(inbr1_img)

    inbr2_img = Image.open("stable_files/gi2.png")
    ...
    grbr1btn = tk.Button(gif_brpg, border=0, borderwidth=0, relief="sunken", image=grbr1photo, cursor="hand2",
       ...
       "name, and preferred "
       "phone number?")])
    grbr1btn.place(relx=0.152, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    clbr1btn = tk.Button(gif_brpg, border=0, borderwidth=0, relief="sunken", image=clbr1photo, cursor="hand2",
       ...
       ".\r\n"
       "Bye 😄")])
    clbr1btn.place(relx=0.832, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    cbbr1btn = tk.Button(gif_brpg, border=0, borderwidth=0, relief="sunken", image=cbbr1photo, cursor="hand2",
       ...
       ".com/sp")])
    cbbr1btn.place(relx=0.152, rely=0.57, anchor=CENTER, width=100, height=30)
    ...
    tsbr1btn = tk.Button(gif_brpg, border=0, borderwidth=0, relief="sunken", image=tsbr1photo, cursor="hand2",
       ...
       "raunprod.service-now"
       ".com/sp﻿")])
    tsbr1btn.place(relx=0.839, rely=0.57, anchor=CENTER, width=99, height=30)
    ...
    snbr1btn = tk.Button(gif_brpg, border=0, borderwidth=0, relief="sunken", image=snbr1photo, cursor="hand2",
       ...
       "raunprod.service-now"
       ".com/sp")])
    snbr1btn.place(relx=0.152, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    apbr1btn = tk.Button(gif_brpg, border=0, borderwidth=0, relief="sunken", image=apbr1photo, cursor="hand2",
       ...
       "raunprod.service-now"
       ".com/sp﻿")])
    apbr1btn.place(relx=0.384, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    mirbr1btn = tk.Button(gif_brpg, border=0, borderwidth=0, relief="sunken", image=mirbr1photo, cursor="hand2",
       ...
       "em outage?")])
    mirbr1btn.place(relx=0.61, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    inbr1btn = tk.Button(gif_brpg, border=0, borderwidth=0, relief="sunken", image=inbr1photo, cursor="hand2",
       ...
       "\r\n"
       "TS:\r\n")])
    inbr1btn.place(relx=0.839, rely=0.832, anchor=CENTER, width=99, height=30)
    ...
    grcp1btn = tk.Button(gif_cpipg, border=0, borderwidth=0, relief="sunken", image=grbr1photo, cursor="hand2",
       ...
       " preferred phone num"
       "ber?")])
    grcp1btn.place(relx=0.152, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    clcp1btn = tk.Button(gif_cpipg, border=0, borderwidth=0, relief="sunken", image=clbr1photo, cursor="hand2",
       ...
       "o follow up.\r\n"
       "Bye 😄")])
    clcp1btn.place(relx=0.832, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    cbcp1btn = tk.Button(gif_cpipg, border=0, borderwidth=0, relief="sunken", image=cbbr1photo, cursor="hand2",
       ...
       "Email: cpi.helpdesk@"
       "cpii.com﻿")])
    cbcp1btn.place(relx=0.152, rely=0.57, anchor=CENTER, width=100, height=30)
    ...
    tscp1btn = tk.Button(gif_cpipg, border=0, borderwidth=0, relief="sunken", image=tsbr1photo, cursor="hand2",
       ...
       "Email: cpi.helpdesk@"
       "cpii.com﻿")])
    tscp1btn.place(relx=0.839, rely=0.57, anchor=CENTER, width=99, height=30)
    ...
    sncp1btn = tk.Button(gif_cpipg, border=0, borderwidth=0, relief="sunken", image=snbr1photo, cursor="hand2",
       ...
       "Email: cpi.helpdesk@"
       "cpii.com﻿")])
    sncp1btn.place(relx=0.152, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    apcp1btn = tk.Button(gif_cpipg, border=0, borderwidth=0, relief="sunken", image=apbr1photo, cursor="hand2",
       ...
       "Email: cpi.helpdesk@"
       "cpii.com﻿")])
    apcp1btn.place(relx=0.384, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    mircp1btn = tk.Button(gif_cpipg, border=0, borderwidth=0, relief="sunken", image=mirbr1photo, cursor="hand2",
       ...
       "rly?")])
    mircp1btn.place(relx=0.61, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    incp1btn = tk.Button(gif_cpipg, border=0, borderwidth=0, relief="sunken", image=inbr1photo, cursor="hand2",
       ...
       "me this worked prope"
       "rly?")])
    incp1btn.place(relx=0.839, rely=0.832, anchor=CENTER, width=99, height=30)
    ...
    grclbri1btn = tk.Button(clbrpg, border=0, borderwidth=0, relief="sunken", image=grbr1photo, cursor="hand2",
       ...
       "me, and preferred ph"
       "one number?")])
    grclbri1btn.place(relx=0.152, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    clclbri1btn = tk.Button(clbrpg, border=0, borderwidth=0, relief="sunken", image=clbr1photo, cursor="hand2",
       ...
       "\r\n"
       "Bye 😄")])
    clclbri1btn.place(relx=0.832, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    cbclbri1btn = tk.Button(clbrpg, border=0, borderwidth=0, relief="sunken", image=cbbr1photo, cursor="hand2",
       ...
       " https://sd.colibrig"
       "roup.com﻿")])
    cbclbri1btn.place(relx=0.152, rely=0.57, anchor=CENTER, width=100, height=30)
    ...
    tsclbri1btn = tk.Button(clbrpg, border=0, borderwidth=0, relief="sunken", image=tsbr1photo, cursor="hand2",
       ...
       " https://sd.colibrig"
       "roup.com﻿")])
    tsclbri1btn.place(relx=0.839, rely=0.57, anchor=CENTER, width=99, height=30)
    ...
    snclbri1btn = tk.Button(clbrpg, border=0, borderwidth=0, relief="sunken", image=snbr1photo, cursor="hand2",
       ...
       " https://sd.colibrig"
       "roup.com")])
    snclbri1btn.place(relx=0.152, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    apclbri1btn = tk.Button(clbrpg, border=0, borderwidth=0, relief="sunken", image=apbr1photo, cursor="hand2",
       ...
       " https://sd.colibrig"
       "roup.com﻿")])
    apclbri1btn.place(relx=0.384, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    mirclbri1btn = tk.Button(clbrpg, border=0, borderwidth=0, relief="sunken", image=mirbr1photo, cursor="hand2",
       ...
       "mpted in detail:")])
    mirclbri1btn.place(relx=0.61, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    inclbri1btn = tk.Button(clbrpg, border=0, borderwidth=0, relief="sunken", image=inbr1photo, cursor="hand2",
       ...
       "\r\n"
       "TS:")])
    inclbri1btn.place(relx=0.839, rely=0.832, anchor=CENTER, width=99, height=30)
    ...
    grfi1btn = tk.Button(gif_FIPpg, border=0, borderwidth=0, relief="sunken", image=grbr1photo, cursor="hand2",
       ...
       ", and preferred phon"
       "e number?")])
    grfi1btn.place(relx=0.152, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    clfi1btn = tk.Button(gif_FIPpg, border=0, borderwidth=0, relief="sunken", image=clbr1photo, cursor="hand2",
       ...
       "\n\r\n"
       "Bye 😄")])
    clfi1btn.place(relx=0.832, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    cbfi1btn = tk.Button(gif_FIPpg, border=0, borderwidth=0, relief="sunken", image=cbbr1photo, cursor="hand2",
       ...
       " Support Center!")])
    cbfi1btn.place(relx=0.152, rely=0.57, anchor=CENTER, width=100, height=30)
    ...
    tsfi1btn = tk.Button(gif_FIPpg, border=0, borderwidth=0, relief="sunken", image=tsbr1photo, cursor="hand2",
       ...
       "to call the Flatiron"
       " Support Center!")])
    tsfi1btn.place(relx=0.839, rely=0.57, anchor=CENTER, width=99, height=30)
    ...
    snfi1btn = tk.Button(gif_FIPpg, border=0, borderwidth=0, relief="sunken", image=snbr1photo, cursor="hand2",
       ...
       "to call the Flatiron"
       " Support Center!")])
    snfi1btn.place(relx=0.152, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    apfi1btn = tk.Button(gif_FIPpg, border=0, borderwidth=0, relief="sunken", image=apbr1photo, cursor="hand2",
       ...
       "to call the Flatiron"
       " Support Center!")])
    apfi1btn.place(relx=0.384, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    mirfi1btn = tk.Button(gif_FIPpg, border=0, borderwidth=0, relief="sunken", image=mirbr1photo, cursor="hand2",
       ...
       "Error/ss:\r\n"
       "TS:")])
    mirfi1btn.place(relx=0.61, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    infi1btn = tk.Button(gif_FIPpg, border=0, borderwidth=0, relief="sunken", image=inbr1photo, cursor="hand2",
       ...
       "Error/ss:\r\n"
       "TS:")])
    infi1btn.place(relx=0.839, rely=0.832, anchor=CENTER, width=99, height=30)
    ...
    grjx1btn = tk.Button(jxpg, border=0, borderwidth=0, relief="sunken", image=grbr1photo, cursor="hand2",
       ...
       " preferred phone num"
       "ber?")])
    grjx1btn.place(relx=0.152, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    cljx1btn = tk.Button(jxpg, border=0, borderwidth=0, relief="sunken", image=clbr1photo, cursor="hand2",
       ...
       "o follow up.\r\n"
       "Bye 😄")])
    cljx1btn.place(relx=0.832, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    cbjx1btn = tk.Button(jxpg, border=0, borderwidth=0, relief="sunken", image=cbbr1photo, cursor="hand2",
       ...
       "ures\r\n"
       "www.jax.org﻿")])
    cbjx1btn.place(relx=0.152, rely=0.57, anchor=CENTER, width=100, height=30)
    ...
    tsjx1btn = tk.Button(jxpg, border=0, borderwidth=0, relief="sunken", image=tsbr1photo, cursor="hand2",
       ...
       "ures\r\n"
       "www.jax.org﻿")])
    tsjx1btn.place(relx=0.839, rely=0.57, anchor=CENTER, width=99, height=30)
    ...
    snjx1btn = tk.Button(jxpg, border=0, borderwidth=0, relief="sunken", image=snbr1photo, cursor="hand2",
       ...
       "ures\r\n"
       "www.jax.org")])
    snjx1btn.place(relx=0.152, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    apjx1btn = tk.Button(jxpg, border=0, borderwidth=0, relief="sunken", image=apbr1photo, cursor="hand2",
       ...
       "ures\r\n"
       "www.jax.org﻿")])
    apjx1btn.place(relx=0.384, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    mirjx1btn = tk.Button(jxpg, border=0, borderwidth=0, relief="sunken", image=mirbr1photo, cursor="hand2",
       ...
       "\r\n"
       "TS:")])
    mirjx1btn.place(relx=0.61, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    injx1btn = tk.Button(jxpg, border=0, borderwidth=0, relief="sunken", image=inbr1photo, cursor="hand2",
       ...
       "\r\n"
       "TS:")])
    injx1btn.place(relx=0.839, rely=0.832, anchor=CENTER, width=99, height=30)
    ...
    grqst1btn = tk.Button(qstpg, border=0, borderwidth=0, relief="sunken", image=grbr1photo, cursor="hand2",
       ...
       "umber?")])
    grqst1btn.place(relx=0.152, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    clqst1btn = tk.Button(qstpg, border=0, borderwidth=0, relief="sunken", image=clbr1photo, cursor="hand2",
       ...
       " to follow up.\r\n"
       "Bye 😄")])
    clqst1btn.place(relx=0.832, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    cbqst1btn = tk.Button(qstpg, border=0, borderwidth=0, relief="sunken", image=cbbr1photo, cursor="hand2",
       ...
       "Hazrat A.\r\n"
       "Quest Diagnostics")])
    cbqst1btn.place(relx=0.152, rely=0.57, anchor=CENTER, width=100, height=30)
    ...
    tsqst1btn = tk.Button(qstpg, border=0, borderwidth=0, relief="sunken", image=tsbr1photo, cursor="hand2",
       ...
       "Hazrat A.\r\n"
       "Quest Diagnostics")])
    tsqst1btn.place(relx=0.839, rely=0.57, anchor=CENTER, width=99, height=30)
    ...
    snqst1btn = tk.Button(qstpg, border=0, borderwidth=0, relief="sunken", image=snbr1photo, cursor="hand2",
       ...
       "Hazrat A.\r\n"
       "Quest Diagnostics")])
    snqst1btn.place(relx=0.152, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    apqst1btn = tk.Button(qstpg, border=0, borderwidth=0, relief="sunken", image=apbr1photo, cursor="hand2",
       ...
       "Hazrat A.\r\n"
       "Quest Diagnostics")])
    apqst1btn.place(relx=0.384, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    mirqst1btn = tk.Button(qstpg, border=0, borderwidth=0, relief="sunken", image=mirbr1photo, cursor="hand2",
       ...
       ":\r\n"
       "Location/Site code:")])
    mirqst1btn.place(relx=0.61, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    inqst1btn = tk.Button(qstpg, border=0, borderwidth=0, relief="sunken", image=inbr1photo, cursor="hand2",
       ...
       ":\r\n"
       "Location/Site code:")])
    inqst1btn.place(relx=0.839, rely=0.832, anchor=CENTER, width=99, height=30)
    ...
    grsbr1btn = tk.Button(sbrpg, border=0, borderwidth=0, relief="sunken", image=grbr1photo, cursor="hand2",
       ...
       " name, and preferred"
       " phone number?")])
    grsbr1btn.place(relx=0.152, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    clsbr1btn = tk.Button(sbrpg, border=0, borderwidth=0, relief="sunken", image=clbr1photo, cursor="hand2",
       ...
       "p.\r\n"
       "Bye 😄")])
    clsbr1btn.place(relx=0.832, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    cbsbr1btn = tk.Button(sbrpg, border=0, borderwidth=0, relief="sunken", image=cbbr1photo, cursor="hand2",
       ...
       "Chat: http://Chat.sa"
       "bra.com﻿")])
    cbsbr1btn.place(relx=0.152, rely=0.57, anchor=CENTER, width=100, height=30)
    ...
    tssbr1btn = tk.Button(sbrpg, border=0, borderwidth=0, relief="sunken", image=tsbr1photo, cursor="hand2",
       ...
       "Chat: http://Chat.sa"
       "bra.com﻿")])
    tssbr1btn.place(relx=0.839, rely=0.57, anchor=CENTER, width=99, height=30)
    ...
    snsbr1btn = tk.Button(sbrpg, border=0, borderwidth=0, relief="sunken", image=snbr1photo, cursor="hand2",
       ...
       "Chat: http://Chat.sa"
       "bra.com")])
    snsbr1btn.place(relx=0.152, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    apsbr1btn = tk.Button(sbrpg, border=0, borderwidth=0, relief="sunken", image=apbr1photo, cursor="hand2",
       ...
       "Chat: http://Chat.sa"
       "bra.com﻿")])
    apsbr1btn.place(relx=0.384, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    mirsbr1btn = tk.Button(sbrpg, border=0, borderwidth=0, relief="sunken", image=mirbr1photo, cursor="hand2",
       ...
       "\r\n"
       "TS:")])
    mirsbr1btn.place(relx=0.61, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    insbr1btn = tk.Button(sbrpg, border=0, borderwidth=0, relief="sunken", image=inbr1photo, cursor="hand2",
       ...
       "\r\n"
       "TS:")])
    insbr1btn.place(relx=0.839, rely=0.832, anchor=CENTER, width=99, height=30)
    ...
    grus1btn = tk.Button(uspg, border=0, borderwidth=0, relief="sunken", image=grbr1photo, cursor="hand2",
       ...
       " preferred phone num"
       "ber?")])
    grus1btn.place(relx=0.152, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    clus1btn = tk.Button(uspg, border=0, borderwidth=0, relief="sunken", image=clbr1photo, cursor="hand2",
       ...
       "o follow up.\r\n"
       "Bye 😄")])
    clus1btn.place(relx=0.832, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    cbus1btn = tk.Button(uspg, border=0, borderwidth=0, relief="sunken", image=cbbr1photo, cursor="hand2",
       ...
       "Email: https://ithel"
       "p@usp.org﻿")])
    cbus1btn.place(relx=0.152, rely=0.57, anchor=CENTER, width=100, height=30)
    ...
    tsus1btn = tk.Button(uspg, border=0, borderwidth=0, relief="sunken", image=tsbr1photo, cursor="hand2",
       ...
       "Email: https://ithel"
       "p@usp.org﻿")])
    tsus1btn.place(relx=0.839, rely=0.57, anchor=CENTER, width=99, height=30)
    ...
    snus1btn = tk.Button(uspg, border=0, borderwidth=0, relief="sunken", image=snbr1photo, cursor="hand2",
       ...
       "Email: https://ithel"
       "p@usp.org﻿")])
    snus1btn.place(relx=0.152, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    apus1btn = tk.Button(uspg, border=0, borderwidth=0, relief="sunken", image=apbr1photo, cursor="hand2",
       ...
       "Email: https://ithel"
       "p@usp.org﻿")])
    apus1btn.place(relx=0.384, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    mirus1btn = tk.Button(uspg, border=0, borderwidth=0, relief="sunken", image=mirbr1photo, cursor="hand2",
       ...
       "me this worked prope"
       "rly?")])
    mirus1btn.place(relx=0.61, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    inus1btn = tk.Button(uspg, border=0, borderwidth=0, relief="sunken", image=inbr1photo, cursor="hand2",
       ...
       "\r\n"
       "TS:")])
    inus1btn.place(relx=0.839, rely=0.832, anchor=CENTER, width=99, height=30)
    ...
    grbl1btn = tk.Button(blpg, border=0, borderwidth=0, relief="sunken", image=grbr1photo, cursor="hand2",
       ...
       "last name, and prefe"
       "rred phone number?")])
    grbl1btn.place(relx=0.152, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    clbl1btn = tk.Button(blpg, border=0, borderwidth=0, relief="sunken", image=clbr1photo, cursor="hand2",
       ...
       "p.\r\n"
       "Bye 😄")])
    clbl1btn.place(relx=0.832, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    cbbl1btn = tk.Button(blpg, border=0, borderwidth=0, relief="sunken", image=cbbr1photo, cursor="hand2",
       ...
       "Deliver. Transform. "
       "Exceed.")])
    cbbl1btn.place(relx=0.152, rely=0.57, anchor=CENTER, width=100, height=30)
    ...
    tsbl1btn = tk.Button(blpg, border=0, borderwidth=0, relief="sunken", image=tsbr1photo, cursor="hand2",
       ...
       "Deliver. Transform. "
       "Exceed.")])
    tsbl1btn.place(relx=0.839, rely=0.57, anchor=CENTER, width=99, height=30)
    ...
    snbl1btn = tk.Button(blpg, border=0, borderwidth=0, relief="sunken", image=snbr1photo, cursor="hand2",
       ...
       "Deliver. Transform. "
       "Exceed.")])
    snbl1btn.place(relx=0.152, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    apbl1btn = tk.Button(blpg, border=0, borderwidth=0, relief="sunken", image=apbr1photo, cursor="hand2",
       ...
       "Deliver. Transform. "
       "Exceed.")])
    apbl1btn.place(relx=0.384, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    mirbl1btn = tk.Button(blpg, border=0, borderwidth=0, relief="sunken", image=mirbr1photo, cursor="hand2",
       ...
       "\r\n"
       "TS:")])
    mirbl1btn.place(relx=0.61, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    inbl1btn = tk.Button(blpg, border=0, borderwidth=0, relief="sunken", image=inbr1photo, cursor="hand2",
       ...
       "\r\n"
       "TS:")])
    inbl1btn.place(relx=0.839, rely=0.832, anchor=CENTER, width=99, height=30)
    ...
    grvr1btn = tk.Button(vrpg, border=0, borderwidth=0, relief="sunken", image=grbr1photo, cursor="hand2",
       ...
       "ame, and preferred p"
       "hone number?")])
    grvr1btn.place(relx=0.152, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    clvr1btn = tk.Button(vrpg, border=0, borderwidth=0, relief="sunken", image=clbr1photo, cursor="hand2",
       ...
       "\r\n"
       "Bye 😄")])
    clvr1btn.place(relx=0.832, rely=0.307, anchor=CENTER, width=100, height=30)
    ...
    cbvr1btn = tk.Button(vrpg, border=0, borderwidth=0, relief="sunken", image=cbbr1photo, cursor="hand2",
       ...
       ".com﻿")])
    cbvr1btn.place(relx=0.152, rely=0.57, anchor=CENTER, width=100, height=30)
    ...
    tsvr1btn = tk.Button(vrpg, border=0, borderwidth=0, relief="sunken", image=tsbr1photo, cursor="hand2",
       ...
       "helpdesk@verabradley"
       ".com﻿")])
    tsvr1btn.place(relx=0.839, rely=0.57, anchor=CENTER, width=99, height=30)
    ...
    snvr1btn = tk.Button(vrpg, border=0, borderwidth=0, relief="sunken", image=snbr1photo, cursor="hand2",
       ...
       "helpdesk@verabradley"
       ".com﻿")])
    snvr1btn.place(relx=0.152, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    apvr1btn = tk.Button(vrpg, border=0, borderwidth=0, relief="sunken", image=apbr1photo, cursor="hand2",
       ...
       "helpdesk@verabradley"
       ".com﻿")])
    apvr1btn.place(relx=0.384, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    mirvr1btn = tk.Button(vrpg, border=0, borderwidth=0, relief="sunken", image=mirbr1photo, cursor="hand2",
       ...
       "Ticket :\r\n"
       "Analyst Name:")])
    mirvr1btn.place(relx=0.61, rely=0.832, anchor=CENTER, width=100, height=30)
    ...
    invr1btn = tk.Button(vrpg, border=0, borderwidth=0, relief="sunken", image=inbr1photo, cursor="hand2",
       ...
       "ving:\r\n"
       "TS:\r\n")])
    invr1btn.place(relx=0.839, rely=0.832, anchor=CENTER, width=99, height=30)
    ...
    brpc = tk.Label(gif_brpg, text='BRAUN', font="Chiller 14 bold", fg='green', compound=CENTER)
    brpc.place(relx=0.5, rely=0.13, anchor=CENTER, width=60, height=30)
    cppc = tk.Label(gif_cpipg, text='CPI', font="Chiller 14 bold", fg='red', background='black', compound=CENTER)
    cppc.place(relx=0.5, rely=0.13, anchor=CENTER, width=60, height=30)
    clbpc = tk.Label(clbrpg, text='COLIBRI', font="Chiller 14 bold", fg='cyan', background='black', compound=CENTER)
    clbpc.place(relx=0.5, rely=0.13, anchor=CENTER, width=65, height=30)
    fipc = tk.Label(gif_FIPpg, text='Flat \nIron', font="Chiller 14 bold", bg='black', fg='white', compound=tk.CENTER)
    fipc.place(relx=0.5, rely=0.13, anchor=CENTER, width=60, height=40)
    jxpc = tk.Label(jxpg, text='JAX', font="Chiller 14 bold", fg='yellow', compound=CENTER)
    jxpc.place(relx=0.5, rely=0.13, anchor=CENTER, width=60, height=30)
    qstpc = tk.Label(qstpg, text='QUEST', font="Chiller 14 bold", fg='red', background='black', compound=CENTER)
    qstpc.place(relx=0.5, rely=0.13, anchor=CENTER, width=60, height=30)
    sbrpc = tk.Label(sbrpg, text='SABRA', font="Chiller 14 bold", fg='cyan', background='black', compound=CENTER)
    sbrpc.place(relx=0.5, rely=0.13, anchor=CENTER, width=65, height=30)
    uspc = tk.Label(uspg, text='USP', font="Chiller 14 bold", fg='yellow', compound=CENTER)
    uspc.place(relx=0.5, rely=0.13, anchor=CENTER, width=60, height=30)
    blpc = tk.Label(blpg, text='BELL', font="Chiller 14 bold", fg='red', background='black', compound=CENTER)
    blpc.place(relx=0.5, rely=0.13, anchor=CENTER, width=60, height=30)
    vrpc = tk.Label(vrpg, text='VERA', font="Chiller 14 bold", fg='white', background='black', compound=CENTER)
    vrpc.place(relx=0.5, rely=0.13, anchor=CENTER, width=65, height=30)
    ...
    def ready_main():
        global maingif_frames, mainframe_delay, scndframe
        maingif_file = Image.open("stable_files/fxf.gif")
        maingif_frames = [ImageTk.PhotoImage(frame.copy()) for frame in ImageSequence.Iterator(maingif_file)]
        mainframe_delay = maingif_file.info['duration']
        cropped_and_resized_frames = []

        # iterate over each frame in the GIF
        for frame in ImageSequence.Iterator(maingif_file):
            # crop the frame
            width, height = frame.size
            top_part = frame.crop((0, 0, width, height // 4))

            # resize the cropped frame
            resized_frame = top_part.resize((140, 60))

            # convert the Image object to PhotoImage and append it to the list
            cropped_and_resized_frames.append(ImageTk.PhotoImage(resized_frame))
            scndframe = cropped_and_resized_frames
        play_main()

    def play_main(frame_count=0):
        global maincurrent_frame
        Labels = [gif_lb, intro_lb, mp2lb, gifFIP_lb, gifcpi_lb, gifbr_lb, clbr_lb, jx_lb,
                  qst_lb, sbr_lb, us_lb, bl_lb, vr_lb]

        Labelsclient = [brpc, cppc, clbpc, fipc, jxpc, qstpc, sbrpc, uspc, blpc, vrpc]

        maincurrent_frame = maingif_frames[frame_count]
        scndcurframe = scndframe[frame_count]

        for label in Labelsclient:
            label.config(image=scndcurframe)

        for label in Labels:
            label.config(image=maincurrent_frame)



        root.after(mainframe_delay, play_main, (frame_count + 1) % len(maingif_frames))
    threading.Thread(target=ready_main).start()
    root.mainloop()
